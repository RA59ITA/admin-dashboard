...
async function main() {
  ...
  // Helper to generate a date offset heavily tied to real time tracking
    ...
    data: [
      {
        ...
        createdAt: getDateOffset(-40) // Historic
      },
      {
        customerId: c1.id, resellerId: reseller1.id, subscriptionType: "Canva Pro",
        ...
        createdAt: getDateOffset(-10) // Recently Renewed
      },
      {
        customerId: c2.id, resellerId: reseller2.id, subscriptionType: "CapCut Pro",
        months: 1, startDate: getDateOffset(-30), expiryDate: getDateOffset(0), // Expiring Today
      ...
      },
      {
        ...
        months: 12, startDate: getDateOffset(-360), expiryDate: getDateOffset(5), // Expiring This Week
      ...
      },
      {
        ...
        months: 1, startDate: getDateOffset(-15), expiryDate: getDateOffset(15), // Expiring this Month
      ...
      },
      {
        ...
        months: 3, startDate: getDateOffset(0), expiryDate: getDateOffset(90), // New today
      ...
      },
      {
        ...
        months: 1, startDate: getDateOffset(0), expiryDate: getDateOffset(30), // New today
