...
export default async function Dashboard() {
  ...
  for (const o of orders) {
    ...
    if (
      cDate.getFullYear() === todayYear &&
      cDate.getMonth() === todayMonth
    ) {
    ...
    >
      ...
      >
        <Card style={{ padding: "20px", borderLeft: "4px solid var(--accent-base)" }}>
          ...
          <div
            style={{
              ...
              fontWeight: 700,
              color:
                netIncomeToday >= 0 ? "var(--text-primary)" : "#f87171",
            }}
          >
            {formatCurrency(netIncomeToday)}
          </div>
          ...
          >
            ...
            <span style={{ color: "#f87171" }}>
              -{formatCurrency(todayExpenses)} Expenses
            </span>
          </div>
        </Card>
        ...
        <Card style={{ padding: "20px", borderLeft: "4px solid #60a5fa" }}>
          ...
          >
            {formatCurrency(netIncomeThisMonth)}
          </div>
